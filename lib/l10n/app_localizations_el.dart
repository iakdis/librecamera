...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get enableMaximumScreenBrightness_description =>
      'Όταν είναι ενεργοποιημένο, η φωτεινότητα της συσκευής θα είναι στο μέγιστο';

  @override
  String get enableModeRow => 'Ενεργοποίηση γραμμής εστίασης και έκθεσης';

  @override
  String get enableModeRow_description =>
      'Ενεργοποίηση μιας σειράς στο κάτω μέρος για την αλλαγή έκθεσης και εστίασης';

  @override
  String get enableZoomSlider => 'Ενεργοποίηση διακόπτη κύλισης ΖΟΟΜ';
  ...
  String get flipPhotosFrontCamera =>
      'Αντιστροφή φωτογραφιών στην μπροστινή κάμερα';
  ...
  String get imageCompressionQuality_description =>
      'Χαμηλότερη ποιότητα συμπίεσης σημαίνει μικρότερο μέγεθος αλλά χειρότερη ποιότητα, ενώ υψηλότερη ποιότητα συμπίεσης σημαίνει μεγαλύτερο μέγεθος αλλά καλύτερη ποιότητα';

  @override
  String get keepEXIFMetadata => 'Σώσε δεδομένα EXIF';
