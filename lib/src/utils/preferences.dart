...
class Preferences {
  ...
  static Future<void> setEnableExposureSlider(bool enable) async =>
  ...
  static Future<void> setStartWithRearCamera(bool rear) async =>
  ...
  static Future<void> setFlipFrontCameraPhoto(bool flip) async =>
  ...
  // Enable Audio
  static Future<void> setEnableAudio(bool enableAudio) async =>
  ...
  // Keep Exif
  static Future<void> setKeepEXIFMetadata(bool keepEXIFMetadata) async =>
      _preferences!.setBool(prefKeepEXIFMetadata, keepEXIFMetadata);
  static bool getKeepEXIFMetadata() =>
      _preferences!.getBool(prefKeepEXIFMetadata) ?? false;

  // Capture Orientation Locked
  static Future<void> setShowNavigationBar(bool showNavigationBar) async =>
      _preferences!.setBool(prefShowNavigationBar, showNavigationBar);
  ...
  // Compress Image
  static Future<void> setDisableShutterSound(bool disable) async =>
  ...
  static Future<void> setMaximumScreenBrightness(bool enable) async =>
      _preferences!.setBool(prefMaximumScreenBrightness, enable);
  static bool getMaximumScreenBrightness() =>
      _preferences!.getBool(prefMaximumScreenBrightness) ?? false;

  // Left Handed Mode
  static Future<void> setLeftHandedMode(bool enable) async =>
      _preferences!.setBool(prefLeftHandedMode, enable);
  static bool getLeftHandedMode() =>
      _preferences!.getBool(prefLeftHandedMode) ?? false;

  // Left Handed Mode
  static Future<void> setCaptureAtVolumePress(bool enable) async =>
