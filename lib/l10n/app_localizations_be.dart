...
class AppLocalizationsBe extends AppLocalizations {
  ...
  @override
  String get selectPath => 'Выберыце шлях';

  @override
  String get welcomeTitle => 'ВІТАЕМ';
  ...
  String get showNavigationBar =>
      'Паказваць панэль навігацыі [ПАТРАБУЕЦЦА ПЕРЕЗАПУСК]';

  @override
  String get showNavigationBar_description =>
      'Заўсёды паказваць панэль навігацыі Андроід';

  @override
  String get focusMode => 'Рэжым факусіроўкі';
  ...
  @override
  String get themeLight => 'Светлая тэма';

  @override
  String get themeDark => 'Цёмная тэма';

  @override
  String get themeBlack => 'Чорная тэма';
